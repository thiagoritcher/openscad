...
w = 1.6;       // separaciÃ³n (ancho liÃ±as)
h = 2 ;        // altura
hex = 60 ;     // lado do hexÃ¡gono
bordo = w ;    // ancho do bordo do hexÃ¡gono

n = 5;        // teselas (formas 5, 6, 8, 9, 11, 12, 13 --> n par)

forma =20 ;
/*  
0:hexÃ¡gonos, 1:cubos, 2:triÃ¡ngulos, 3:cadrados random,
4:triÃ¡ngulos random,5:asahona, 6:soles, 7:pÃ©talos, 
8:FlowerOfLife1, 9:FlowerOfLife2, 10:cÃ­rculos superpostos, 
11:flores, 12: malla, 13: pajarita nazarÃ­, 14: trapecios,
15: estrelas-cubos, 16: Francois stone mosaic, 17: entrelazado,
18:FlowerOfLife3,19:flores2, 20:rectÃ¡ngulos superpostos, 
21: cÃ­rculos1, 22: cÃ­rculos2, 23: cÃ­rculos3, 
24: estrelas e hexÃ¡gonos 1, 25: estrelas e hexÃ¡gonos 2, 
26: estrelas e hexÃ¡gonos 3, 27: estrelas e hexÃ¡gonos 4, 
28: cÃ­rculos e triÃ¡ngulos, 29: estrelas e cadrados, 30: 
cubos2, 31: ondas1, 32: ondas2, 33: aspas 
*/

res = 60;       // resoluciÃ³n dos cÃ­rculos
...
// diÃ¡metro tesela (altura hexÃ¡gono)
d =                             
n==0 ? 0: 
...
// Inserir a teselaciÃ³n dentro dun hexÃ¡gono

// parÃ¡metros para centrar o hexÃ¡gono
